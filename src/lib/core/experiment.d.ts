import { IExperiment, IExperimentMeta, ISingleVariantExperiment } from '../types/experiment.interface';
...
export declare abstract class ExperimentService {
     ...
     */
    protected addExperiment(experiment: IExperiment): Promise<void>;
    /**
     ...
     */
    updateExperiment(updatedExperiment: IExperiment): Promise<void>;
    /**
     ...
     */
    validateExperiment(experiment: IExperiment): boolean;
    /**
