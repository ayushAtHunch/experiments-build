...
class ExperimentService {
    ...
    getExperimentById(experimentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const experiments = yield this.storeHandler.read();
    ...
    getExperimentsByBaseEntityId(baseEntityId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const experiments = yield this.storeHandler.read();
            return experiments.filter((exp) => exp.baseEntityId === baseEntityId);
        });
    }
    ...
    getActiveExperimentsByBaseEntityId(baseEntityId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const experiments = yield this.storeHandler.read();
            return experiments.filter((exp) => exp.baseEntityId === baseEntityId && exp.isActive);
        });
    }
    /**
    ...
    addExperiment(experiment) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (experiments.some((e) => e.id === experiment.id)) {
                throw new errors_1.ExperimentValidationError(`Experiment with ID "${experiment.id}" already exists`);
            }
            // Check for duplicate slugs
            if (experiments.some((e) => e.slug === experiment.slug)) {
                throw new errors_1.ExperimentValidationError(`Experiment with slug "${experiment.slug}" already exists`);
            }
            experiments.push(experiment);
            yield this.storeHandler.write(experiments);
        });
    }
    /**
    ...
    deleteExperiment(experimentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.storeHandler.write(filtered);
        });
    }
    /**
    ...
    validateExperiment(experiment) {
        ...
        if (!experiment.id) {
            throw new errors_1.ExperimentValidationError('Experiment ID is required');
        }
        ...
        if (totalWeight <= 0) {
            throw new errors_1.ExperimentValidationError('Total variant weight must be greater than 0');
        }
        return true;
    }
    /**
    ...
    generateMeta(payload) {
        const { slug: experimentSlug, variant: { slug: variantSlug }, experimentBase, baseEntityId, } = payload;
