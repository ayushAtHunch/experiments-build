...
class ExperimentService {
    ...
    deleteExperiment(experimentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!experiment) {
                throw new errors_1.ExperimentNotFoundError(`Experiment with ID "${experimentId}" not found`);
            }
    ...
    activateExperiment(experimentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.storeHandler.activateExperiment(experimentId);
        });
    }
    /**
    ...
    deactivateExperiment(experimentId) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.storeHandler.deactivateExperiment(experimentId);
        });
    }
    /**
