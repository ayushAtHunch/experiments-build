...
- **experiments**: Main experiment configuration (id, name, slug, is_active, experiment_base, base_entity_id)
- **experiment_variants**: Variant definitions with weights and values

Proper indexing is implemented on key fields for optimal query performance.
